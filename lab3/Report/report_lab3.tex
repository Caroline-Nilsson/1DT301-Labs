...
\begin{figure}[h]
\centering
\includegraphics[scale=0.5]{flowcharts/a1_diagram.png} 
\caption{Toggle LED0 on Switch pressed using interrupt}
\label{assign1.flow}
\end{figure}
...
\begin{figure}[h]
\centering
\includegraphics[scale=0.3]{flowcharts/a2_diagram.png} 
\caption{Johnson/Ring counter toggle using interrupt}
\label{assign2.flow}
\end{figure}
...
\begin{figure}[h]
\centering
\includegraphics[scale=0.4]{flowcharts/a3_diagram.png} 
\caption{Simulating rear lights blink right/blink left}
\label{}
\end{figure}
...
\begin{figure}[h]
\centering
\includegraphics[scale=0.35]{flowcharts/a4_diagram.png} 
\caption{Simulating rear lights blink right/blink left/brake}
\label{}
\end{figure}
