...
\caption{Generate random numbers: $1 - 75$}
\label{assign2.flow}
\end{figure}
...
\caption{Receive character from serial port and display it}
\label{}
\end{figure}
...
\begin{figure}[h]
\centering
\includegraphics[scale=0.3]{flowcharts/a4_flowchart.png} 
\caption{Receive 4 lines from serial port and display each line 5 sec in a loop}
\label{}
\end{figure}
